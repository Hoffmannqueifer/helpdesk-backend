...
public class DBService {
	...
	public void instanciaDB() {
		...
		Chamado c = new Chamado(null, Prioridade.MEDIA, Status.ANDAMENTO, "Chamado 01", "Primeiro chamado", tec, cli);
		...
		tecnicoRepository.saveAll(Arrays.asList(tec, tec1, tec2, tec3, tec4, tec5));
		clienteRepository.saveAll(Arrays.asList(cli, cli1, cli2, cli3, cli4, cli5));
		chamadoRepository.saveAll(Arrays.asList(c, c1, c2, c3, c4, c5, c6));
	}
}
